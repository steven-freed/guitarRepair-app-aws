...
@property (strong, atomic) AWSFormTableCell *emailRow;
...
- (void)setUpUserPoolsUI {
    if (self.config.enableUserPoolsUI) {
        ...
        self.emailRow = [[formTableCell alloc] initWithPlaceHolder:@"Email"
                                                                 type:InputTypeText];
...
- (void)handleUserPoolSignIn {
    ...
    [userPoolsOperations loginWithUserName:[self.tableDelegate getValueForCell:self.emailRow forTableView:self.tableView]
